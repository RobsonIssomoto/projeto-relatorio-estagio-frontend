    ...
    <Container maxWidth="xs">
      <Paper elevation={3} sx={{ p: 4, display: "flex", flexDirection: "column" }}>
        ...
        <Box
          ...
          <TextField label="CNPJ (apenas números)" required fullWidth size="small" />
          ...
          <TextField label="Nome do Representante" required fullWidth size="small" />
            ...
            {regrasSenha.map((regra) => (
              <Typography
                ...
                sx={{
                  display: "flex",
                  alignItems: "center",
                  // Transição suave de cor do cinza para o verde da Fatec
